...
*       ---------------------------------------------------------
*
*       Hermite integration method with Ahmad-Cohen neighbour scheme.
*       -------------------------------------------------------------
*
...
*
*
*     Added 05/12/13 JDor   Initialize NSTEPOUT - used for outputing snapshots
      NSTEPOUT=0
...
*       Check reading modified restart parameters (KSTART = 3, 4 or 5).
      ...
      END IF
*
      PRINT '(A,A)' , 'starting integration'
